(() => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    new FullCalendar.Draggable(n, {
      itemSelector: ".fc-event",
      eventData: function (t) {
        var n;
        return (
          e((n = { title: t.innerText.trim() }), "title", t.innerText),
          e(n, "className", t.className + " overflow-hidden "),
          n
        );
      },
    });
