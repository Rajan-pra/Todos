        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title mb-0 text-primary">Edit</h4>
                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="slug" placeholder="Slug"
                                            name="slug" value="{{ $todo->slug }}" required>
                                        @if ($errors->has('slug'))
                                            <span class="error">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select name="status" id="type" class="form-control">
                                            <option value="0"
                                                {{ old('status', $todo->status) == 0 ? 'selected' : '' }}>Pending</option>
                                            <option value="1"
                                                {{ old('status', $todo->status) == 1 ? 'selected' : '' }}>Completed</option>
                                        </select>
